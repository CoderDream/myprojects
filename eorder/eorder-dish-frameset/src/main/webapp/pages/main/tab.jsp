...
<link href="<%=request.getContextPath()%>/resources/css/select.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery.idTabs.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/select-ui.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/editor/kindeditor.js"></script>
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<ul class="forminfo">
					...
					<li><label>通知内容<b>*</b></label> <textarea id="content7" name="content"
				...
				<table class="tablelist">
					<thead>
						<tr>
							...
							<th>编号<i class="sort"><img src="<%=request.getContextPath()%>/resources/images/px.gif" /></i></th>
							<th>标题</th>
							<th>用户</th>
							<th>籍贯</th>
							<th>发布时间</th>
